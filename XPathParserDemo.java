...
public class XPathParserDemo {
    ...
    {
        String inputFile = "/Users/ankursingh/Ankur/JavaWorkSpace/XmlParesr/data.xml";
        ...
        XPathExpression allProductsExpression = xpath.compile("//product/fruit/supplier/text()");
        ...
        for (String supplier : suppliers)
        {
            ...
            StreamResult result =  new StreamResult(new File( supplier.trim() + ".xml"));
